...
import {getTokensMarketData, MarketTokenItem} from "@/app/actions/token-actions";
      ...
      <div className="flex flex-col gap-4">
        {
          Object.entries(poolsMap).map(([key, value]) => {
            ...
            return value.pools.map(p => (
              <AccordionItem value={`${key}-${p.days}`} key={key} className="border-0 outline-0 no-underline">
